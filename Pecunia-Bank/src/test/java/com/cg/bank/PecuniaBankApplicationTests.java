...
RestTemplate restTemplate = new RestTemplate();
    ...
    final String baseUrl = "http://localhost:" + 8085 + "/passbook/updatePassbook/123456789456";
    ...
    final String baseUrl = "http://localhost:" + 8085 + "/passbook/accountSummary/123456789456/2020-10-02/2020-10-04" ;
    URI uri = new URI(baseUrl);
    ResponseEntity<Transactions[]> result = restTemplate.getForEntity(uri, Transactions[].class);
    Assertions.assertEquals(200, result.getStatusCodeValue());
